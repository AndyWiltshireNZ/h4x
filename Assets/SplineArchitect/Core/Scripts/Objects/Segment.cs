...
namespace SplineArchitect.Objects
{
    ...
    public partial class Segment
    {
        ...
        [HideInInspector]
        public Vector3 connectorPosOffset;
        [HideInInspector]
        public Quaternion connectorRotOffset = Quaternion.identity;
        ...
        public void TranslateAnchorForward(float length, Space space = Space.World)
        {
            Vector3 dir = GetDirection();

            Translate(ControlHandle.ANCHOR, dir * length, space);
            Translate(ControlHandle.TANGENT_A, dir * length, space);
            Translate(ControlHandle.TANGENT_B, dir * length, space);
        ...
        public void SetInterpolationMode(InterpolationType interpolationMode)
        {
            ...
            if (interpolationMode == InterpolationType.SPLINE)
            {
        ...
        public void UpdateLineOrientation()
        {
        ...
        public bool LinkToAnchor(Vector3 linkPoint, bool ForceLinkUnlinked = true)
        {
            ...
            else splines = HandleRegistry.GetSplines();

            SplineUtility.GetSegmentsAtPointNoAlloc(closestSegmentContainer, splines, linkPoint);
#else
