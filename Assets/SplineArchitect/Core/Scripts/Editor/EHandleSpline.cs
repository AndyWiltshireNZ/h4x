    ...
    public static class EHandleSpline
    {
        ...
        public static void InitalizeEditor(Spline spline, bool firstInitialization)
        {
            ...
            else
            {
                ...
                {
                    EHandleEvents.InvokeSplineCopied(spline);
            ...
            UnityEngine.Rendering.RenderPipelineManager.endCameraRendering += spline.EndCameraRendering;
            Camera.onPostRender += spline.OnPostCamera;
        ...
        {
            bool segementChange = spline.monitor.SegmentChange();
            ...
            bool zRotContSaddleScaleChange = spline.monitor.ExtraChange();
        ...
        public static void ProcessMarkedForInfoUpdates()
        {
            ...
            for (int i2 = markedInfoUpdates.Count - 1; i2 >= 0; i2--)
            {
                ...
                for (int i = spline.allSplineObjects.Count - 1; i >= 0; i--)
                {
