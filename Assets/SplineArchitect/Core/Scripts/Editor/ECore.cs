...
namespace SplineArchitect
{
    public static partial class ECore
    {
        ...
        private static void OnPlayModeStateChanged(PlayModeStateChange state)
        {
            ...
            HandleDeformation.ClearWorkers();
        ...
        private static void Update()
        {
            ...
            EHandleMeshContainer.RefreshAfterAssetImport(HandleRegistry.GetSplines());
        ...
        private static void OnRedoEvents(in UndoRedoInfo undo)
        {
            ...
            //Is here for fixing an undo + prefab case. If you revert a deformation prefab and then do Undo it will not deform properly, with this it will.
            SplineObject selectedSo = EHandleSelection.selectedSplineObject;
            if (selectedSo != null)
            {
                selectedSo.monitor.ForceUpdateEditor();
                foreach(SplineObject so in EHandleSelection.selectedSplineObjects) so.monitor.ForceUpdateEditor();
            }
