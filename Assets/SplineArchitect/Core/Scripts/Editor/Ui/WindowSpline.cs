    ...
    public class WindowSpline : WindowBase
    {
        ...
        protected override void OnGUIExtended()
        {
            ...
            if (spline.selectedSplineMenu == "deformation")
            {
                ...
                {
                    GUILayout.BeginHorizontal(EUiUtility.GetBackgroundStyle());
                    EUiUtility.CreateInfoMessageIcon(LibraryGUIContent.infoMsgUpdateType, true);
                ...
                if (spline.normalType == Spline.NormalType.DYNAMIC)
                {
                    ...
                    EUiUtility.CreateSliderAndInputField("Normal resolution:", spline.GetResolutionNormal(true), (newValue, changeBySlider) => {
                        EHandleSelection.UpdatedSelectedSplinesRecordUndo((selected) =>
                        {
                ...
                EUiUtility.CreateSliderAndInputField("Spline resolution:", spline.GetResolutionSpline(true), (newValue, changeBySlider) => {
                    EHandleSelection.UpdatedSelectedSplinesRecordUndo((selected) =>
                    {
                ...
                EUiUtility.CreateToggleField("Draw in game:", spline.drawInGame, (newValue) =>
                {
                    EHandleSelection.UpdatedSelectedSplinesRecordUndo((selected) =>
                    {
                        selected.drawInGame = newValue;
        ...
        protected override void UpdateWindowSize()
        {
            ...
            else
            {
                if (spline.selectedSplineMenu == "deformation")
                {
                    ...
                    cachedRect.height = menuItemHeight * 9 + 10;
