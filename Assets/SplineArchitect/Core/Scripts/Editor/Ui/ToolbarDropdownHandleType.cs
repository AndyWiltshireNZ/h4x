...
namespace SplineArchitect.Ui
{
    ...
    public class ToolbarDropdownHandleType : EditorToolbarDropdown
    {
        ...
        {
            HandleType handleType = EGlobalSettings.GetHandleType();
        ...
        void ShowMenu()
        {
            ...
            {
                EGlobalSettings.SetHandleType(HandleType.MIRRORED);
            ...
            {
                EGlobalSettings.SetHandleType(HandleType.CONTINUOUS);
            ...
            {
                EGlobalSettings.SetHandleType(HandleType.BROKEN);
