...
namespace SplineArchitect
{
    public class EHandleEvents
    {
        ...
        public static bool undoWasRedo;
        public static bool controlPointCreationActive;
        ...
        public static event Action<Event, bool> OnWindowSplineGUI;
        public static event Action<Event, bool> OnWindowControlPointGUI;
        ...
        public static event Action<Spline> OnSplineFlatten;
        public static event Action<Spline, Spline> OnSplineSplit;
        public static event Action<Spline> AfterSegmentRemoved;
        public static event Action<Spline> OnSplineCopied;
        ...
        public static event Action<Segment, Segment.ControlHandle> OnSegmentMovement;
        public static event Action<Segment> OnSegmentRemoved;
        public static event Action<Segment> OnSegmentLinked;
        public static event Action<Segment> OnSegmentFlatten;
        public static event Action<SplineConnector, Segment> OnSplineConnectorAlignSegment;
        ...
        public static event Action<Object> OnAssetImported;
        ...
        public static void InvokeSegmentFlatten(Segment segment)
        {
            OnSegmentFlatten?.Invoke(segment);
        }

        public static void InvokeSplineConnectorAlignSegment(SplineConnector splineConnector, Segment segment)
        {
            OnSplineConnectorAlignSegment?.Invoke(splineConnector, segment);
        }

        public static void InvokeSegmentLinked(Segment segment)
        {
            OnSegmentLinked?.Invoke(segment);
        }

        public static void InvokeAfterSegmentRemoved(Spline spline)
        {
        ...
        public static void InvokeSegmentMovement(Segment segment, Segment.ControlHandle controlHandle)
        {
        ...
        public static void InvokeSplineFlatten(Spline spline)
        {
        ...
        public static void InvokeSplineCopied(Spline spline)
        {
        ...
        public static void InvokeWindowSplineGUI(Event e, bool leftMouseUp)
        {
            OnWindowSplineGUI?.Invoke(e, leftMouseUp);
        }

        public static void InvokeWindowControlPointGUI(Event e,bool leftMouseUp)
        {
            OnWindowControlPointGUI?.Invoke(e, leftMouseUp);
        }

        public static void InvokeAssetImported(Object obj)
        {
