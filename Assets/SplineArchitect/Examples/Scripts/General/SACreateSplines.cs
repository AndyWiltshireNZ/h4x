    ...
    public class SACreateSplines : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if(splineToMove != null)
            {
                ...
                splineToMove.segments[0].SetAnchorPosition(newPoint);
                splineToMove.monitor.ForceUpdate();
        ...
        private Spline CreateSpline(Transform startPoint, Transform endPoint)
        {
            ...
            //Link spline
            spline.segments[0].LinkToAnchor(spline.segments[0].GetPosition(Segment.ControlHandle.ANCHOR));
        ...
        public void CreateDeformations(Spline spline)
        {
            for(int i = 0; i < prefabAmounts; i++)
            {
                ...
                {
                    splineObject.snapMode = SplineObject.SnapMode.CONTROL_POINTS;
                    splineObject.snapLengthEnd = 50;
                }
            }
        }
    }
